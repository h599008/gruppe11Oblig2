...
class TabellerEnhetsTester {
	...
	@Test
	void testSummerFor() {
		assertEquals(11,Tabeller.summerFor(tabell1));
		assertEquals(1,Tabeller.summerFor(tabell2));
		assertEquals(0,Tabeller.summerFor(tabell3));
	}
	...
	@Test
	void testSummerExtFor() {
		assertEquals(11,Tabeller.summerExtFor(tabell1));
		assertEquals(1,Tabeller.summerExtFor(tabell2));
		assertEquals(0,Tabeller.summerExtFor(tabell3));
	}
